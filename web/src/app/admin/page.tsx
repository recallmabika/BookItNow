...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="min-h-screen flex bg-[#F8FAFC] dark:bg-[#070B14] text-gray-900 dark:text-gray-100">
      {/* ============================================================ */}
      {/* PROFESSIONAL EXECUTIVE SIDEBAR (MATCHING NAVBAR #2563EB)     */}
      {/* ============================================================ */}
      <aside
        className={`fixed top-0 bottom-0 left-0 z-30 w-64 bg-[#2563EB] border-r border-[#1D4ED8] text-white flex flex-col justify-between transition-transform duration-200 lg:translate-x-0 shadow-lg ${
          sidebarOpen ? "translate-x-0" : "-translate-x-full"
        }`}
      >
        <div className="flex flex-col h-full">
          {/* Workspace & Portal Header with real BookItNow Logo */}
          <div className="p-4 border-b border-[#1D4ED8] bg-[#1D4ED8] flex items-center justify-between">
            <Link href="/" className="flex items-center gap-3 group">
              <div className="relative w-10 h-10 rounded-full overflow-hidden shrink-0 shadow-md ring-1 ring-white/40 bg-white/10">
                <Image
                  src="/logo.png"
                  alt="BookItNow Logo"
                  fill
            ...
            <button
              ...
              className="lg:hidden p-1.5 text-white/80 hover:text-white rounded-xs"
            >
              <X className="w-4 h-4" />
            </button>
          </div>
          ...
          <nav className="p-3 space-y-1 flex-1 overflow-y-auto">
            <div className="px-3 pt-2 pb-1.5 text-[10px] font-bold uppercase tracking-wider text-blue-200">
            ...
            <button
              ...
              className={`w-full flex items-center justify-between px-3 py-2.5 rounded-xs text-xs font-semibold transition-all cursor-pointer ${
                activeTab === "overview"
                  ? "bg-white text-[#2563EB] shadow-md font-bold"
            ...
            >
              ...
              <span
                className={`text-[10px] px-1.5 py-0.5 rounded-full font-mono ${
                  activeTab === "properties" ? "bg-blue-100 text-[#2563EB]" : "bg-[#1D4ED8] text-white"
                }`}
              >
                {properties.length}
              </span>
            ...
            <Link
              href="/host/inventory"
              className="w-full flex items-center justify-between px-3 py-2.5 rounded-xs text-xs font-semibold text-white/90 hover:text-white hover:bg-white/15 transition-all cursor-pointer"
            >
              <div className="flex items-center gap-2.5">
            ...
            >
              ...
              <span
                className={`text-[10px] px-1.5 py-0.5 rounded-full font-mono ${
                  activeTab === "bookings" ? "bg-blue-100 text-[#2563EB]" : "bg-[#1D4ED8] text-white"
                }`}
              >
                {bookings.length}
              </span>
            ...
            <div className="px-3 pt-5 pb-1.5 text-[10px] font-bold uppercase tracking-wider text-blue-200">
              Access & Security
            </div>
            ...
            >
              ...
              <span
                className={`text-[10px] px-1.5 py-0.5 rounded-full font-mono ${
                  activeTab === "users" ? "bg-blue-100 text-[#2563EB]" : "bg-[#1D4ED8] text-white"
                }`}
              >
                {usersList.length}
              </span>
            ...
            <button
              ...
              className="w-full flex items-center gap-2.5 px-3 py-2.5 text-xs font-semibold text-emerald-200 hover:bg-white/15 rounded-xs transition-colors cursor-pointer"
            >
            ...
            <button
              ...
              className="w-full flex items-center gap-2.5 px-3 py-2.5 text-xs font-semibold text-cyan-200 hover:bg-white/15 rounded-xs transition-colors cursor-pointer"
            >
